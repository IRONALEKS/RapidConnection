...
public class RapidConnection
{
	...
	/**
	 * Connects a new {@link SocketChannel} to the given address and wraps the {@link SocketChannel} into this {@link RapidConnection}
	 * @param  connect The {@link String} address to connect this {@link RapidConnection} to
	 * @param  portconnect The port to connect this {@link RapidConnection} to
	 * @param  blocking The blocking mode to set the {@link SocketChannel} that will be wrapped by this {@link RapidConnection}
	 */
	public void Connect(String connect, int portconnect,boolean blocking)
	{
		SocketChannel temp = ConnectionMaker.newSocketChannel(connect, portconnect, blocking, infoANDdebug.getINFO(), infoANDdebug.getDEBUG());
	...
	/**
	 * Connects a new {@link SocketChannel} to the given address and wraps the {@link SocketChannel} into this {@link RapidConnection}
	 * @param  connect The {@link InetSocketAddress} address to connect this {@link RapidConnection} to
	 * @param  blocking The blocking mode to set the {@link SocketChannel} that will be wrapped by this {@link RapidConnection}
	 */
	public void Connect(InetSocketAddress connect,boolean blocking)
	{
		SocketChannel temp = ConnectionMaker.newSocketChannel(connect, blocking, infoANDdebug.getINFO(), infoANDdebug.getDEBUG());
		
		Link(temp);
	}

	/**
	 * Connects a new {@link SocketChannel} to the given address and binds to the given address and then wraps the {@link SocketChannel} into this {@link RapidConnection}
	 * @param  bind The {@link String} address to bind this {@link RapidConnection} to
	 * @param  portbind The port to bind this {@link RapidConnection} to
	 * @param  connect The {@link String} address to connect this {@link RapidConnection} to
	 * @param  portconnect The port to connect this {@link RapidConnection} to
	 * @param  blocking The blocking mode to set the {@link SocketChannel} that will be wrapped by this {@link RapidConnection}
	 */
	public void Connect(String bind, int portbind, String connect, int portconnect,boolean blocking)
	{
		SocketChannel temp = ConnectionMaker.newSocketChannel(bind, portbind, connect, portconnect, blocking, infoANDdebug.getINFO(), infoANDdebug.getDEBUG());
	...
	/**
	 * Connects a new {@link SocketChannel} to the given address and binds to the given address and then wraps the {@link SocketChannel} into this {@link RapidConnection}
	 * @param  bind The {@link InetSocketAddress} address to bind this {@link RapidConnection} to
	 * @param  connect The {@link InetSocketAddress} address to connect this {@link RapidConnection} to
	 * @param  blocking The blocking mode to set the {@link SocketChannel} that will be wrapped by this {@link RapidConnection}
	 */
	public void Connect(InetSocketAddress bind, InetSocketAddress connect, int portconnect,boolean blocking)
	{
		SocketChannel temp = ConnectionMaker.newSocketChannel(bind, connect, blocking, infoANDdebug.getINFO(), infoANDdebug.getDEBUG());
		
		Link(temp);
	}
	
	/**
	 * Wraps the socketchannel into this {@link RapidConnection}
	 * @param  socketchannelv The SocketChannel to be wrapped by this {@link RapidConnection}
	 */
	//CONNECTION
	public void Link(SocketChannel socketchannelv)
	{
		if(connected)
		{
			Disconnect();
	...
	/**
	 * Wraps the socketchannel into this {@link RapidConnection} and sets it's blocking mode to the given value
	 * @param  socketchannelv The SocketChannel to wrap by this {@link RapidConnection}
	 * @param  blocking The value to set the blocking mode of the given {@link RapidConnection}
	 */
	public void Link(SocketChannel socketchannelv,boolean blocking)
	{
		if(connected)
		{
			Disconnect();
	...
	/**
	 * Closes the connection, and this {@link RapidConnection} can be reused for new connections
	 */
	...
	/**
	 * Sets this {@link RapidConnection} to be blocking
	...
	/**
	 * Sets this {@link RapidConnection} to be non-blocking
	 * @return Returns {@code true} if the opperation succeeded {@code false} otherwise
	 */
	...
	/**
	 * Sets this {@link RapidConnection} blocking mode to the given value
	 * @param value The value to set the blocking mode of this {@link RapidConnection}
	 * @return Returns {@code true} if the opperation succeeded {@code false} otherwise
	 */
